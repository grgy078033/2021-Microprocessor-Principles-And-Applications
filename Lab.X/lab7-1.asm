...
; CONFIG7H
  ...
  DELAY MACRO NUM1, NUM2 ; DELAY d'200', d'90'
	...
	DECFSZ L2,1
	BRA LOOP2
ENDM ; 2+(2+7*200+2)*90 = 126362 , close to 0.5sec
	
ISR: ; Intterupt Service Routine
    ORG 0x08
    BTG PORTD, 0 // toggle RD0 LED
    DELAY d'200', d'90'
...
INITIAL:
    ...
    BSF PORTD, 0 // RD0 LED light on first
...
MAIN:
    ...
    BRA MAIN ; button not press, goto check_press
    BSF INTCON, INT0IF // set interrupt flag bit
END