...
ISR:
    ...
    RETFIE FAST
INITIAL:
    MOVLW B'00000010' ;set TRISA (ready to go state 2)
    MOVWF TRISA ;TRIAS = '00000001'
...
CHANGE:
    MOVWF LATD
    BTFSC TRISA, 0 ;if is state 1
    MOVLW B'00100000' ;internal oscillator 250kHZ
    BTFSC TRISA, 1 ;if is state 2
    MOVLW B'00110000' ;internal oscillator 500kHZ
    BTFSC TRISA, 2 ;if is state 3
    MOVLW B'01000000' ;internal oscillator 1MHZ
    MOVWF OSCCON ; set internal oscillator
    
    RLCF TRISA ; TRISA shift left
    MOVLW D'00000001'
    BTFSC TRISA, 3
    MOVWF TRISA ; TRISA set to begin (state 1)
